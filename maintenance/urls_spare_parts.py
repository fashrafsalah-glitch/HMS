...
urlpatterns = [
    ...
    # Spare Part URLs
    path('', views_spare_parts.spare_part_list, name='spare_part_list'),
    path('<int:pk>/', views_spare_parts.spare_part_detail, name='spare_part_detail'),
    path('create/', views_spare_parts.spare_part_create, name='spare_part_create'),
    path('<int:pk>/update/', views_spare_parts.spare_part_update, name='spare_part_update'),
